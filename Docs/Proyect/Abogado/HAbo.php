<?php 
  ...
  $query= "SELECT Cliente.Nombre,Cliente.ApP, Cliente.ApM,Cliente.ApP,Caso.Costo, Caso.Estado,Caso.Detalle,Caso.FechaInicio, Caso.FechaTerm,Caso.Estado FROM Caso,Cliente,Abogado WHERE Cliente.idCliente= Caso.ClienteidCliente AND Cliente.idCliente='{$id}' AND Caso.AbogadoidAbogado=Abogado.idAbogado";
  ...
  $query= "SELECT Usuario FROM Abogado WHERE idAbogado ='{$id}'";
