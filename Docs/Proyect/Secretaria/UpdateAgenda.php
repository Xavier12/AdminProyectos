	...
	<div id="main-content">
		...
		<div class="row">
			<div class="small-12 large-12 small-centered large-centered columns">
				<form method="POST" action="index.php?pag=modAgenda&idea=<?=$rowAgenda['idAgenda']?>">
					<div class="row">
						<div class="large-6 large-centered columns">
							<label>Actividad</label>
							<input type="text" name="txtAct" placeholder="Actividades a realizar" value="<?=$rowAgenda['Actividad']?>">
						</div>
					</div>
					<div class="row">
						<div class="large-6 large-centered columns">
							<label>Lugar</label>
							<input type="text" name="txtLugar" placeholder="Lugar de la cita" value="<?=$rowAgenda['Lugar']?>">
						</div>
					</div>
					<div class="row">
						<div class="large-6 large-centered columns">
							<label>Dirección</label>
							<input type="text" name="txtDir" placeholder="Dirección del lugar" value="<?=$rowAgenda['Direccion']?>">
						</div>
					</div>
					<div class="row">
						<div class="large-6 large-centered columns">
							<label>Hora</label>
							<input type="text"  name="txtHr" placeholder="Horario" value="<?=$rowAgenda['Hr']?>">
						</div>
					</div>
