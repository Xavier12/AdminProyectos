...
-- -----------------------------------------------------
-- Table `despacho`.`Telefono`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `despacho`.`Telefono` (
  `idTelefono` INT NOT NULL AUTO_INCREMENT,
  `Numero` VARCHAR(15) NOT NULL,
  `ClienteidCliente` INT NOT NULL,
  `AbogadoidAbogado` INT NOT NULL,
  PRIMARY KEY (`idTelefono`),
  INDEX `fk_Telefono_Cliente1_idx` (`ClienteidCliente` ASC),
  INDEX `fk_Telefono_Abogado1_idx` (`AbogadoidAbogado` ASC),
  CONSTRAINT `fk_Telefono_Cliente1`
    FOREIGN KEY (`ClienteidCliente`)
    REFERENCES `despacho`.`Cliente` (`idCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Telefono_Abogado1`
    FOREIGN KEY (`AbogadoidAbogado`)
    REFERENCES `despacho`.`Abogado` (`idAbogado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `despacho`.`UsurioSecre`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `despacho`.`UsurioSecre` (
  `idUsurioSecre` INT NOT NULL AUTO_INCREMENT,
  `Usuario` VARCHAR(15) NOT NULL,
  `Password` VARCHAR(15) NOT NULL,
  `SecretariaidSecretaria` INT NOT NULL,
  PRIMARY KEY (`idUsurioSecre`),
  INDEX `fk_UsurioSecre_Secretaria1_idx` (`SecretariaidSecretaria` ASC),
  CONSTRAINT `fk_UsurioSecre_Secretaria1`
    FOREIGN KEY (`SecretariaidSecretaria`)
    REFERENCES `despacho`.`Secretaria` (`idSecretaria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `despacho`.`UsuarioCliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `despacho`.`UsuarioCliente` (
  `idUsuarioCliente` INT NOT NULL AUTO_INCREMENT,
  `Usuario` VARCHAR(15) NOT NULL,
  `Password` VARCHAR(15) NOT NULL,
  `ClienteidCliente` INT NOT NULL,
  PRIMARY KEY (`idUsuarioCliente`),
  INDEX `fk_UsuarioCliente_Cliente1_idx` (`ClienteidCliente` ASC),
...
-- -----------------------------------------------------
-- Table `despacho`.`UsuarioAbogado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `despacho`.`UsuarioAbogado` (
  `idUsuarioAbogado` INT NOT NULL AUTO_INCREMENT,
  `Usuario` VARCHAR(15) NOT NULL,
  `Password` VARCHAR(15) NOT NULL,
  `AbogadoidAbogado` INT NOT NULL,
  PRIMARY KEY (`idUsuarioAbogado`),
  INDEX `fk_UsuarioAbogado_Abogado1_idx` (`AbogadoidAbogado` ASC),
